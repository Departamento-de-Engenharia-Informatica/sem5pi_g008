...
export default async ({expressApp}) => {
    ...
    const medicalRecordConditionController = {
        name: config.controllers.medicalRecordMedicalCondition.name,
        path: config.controllers.medicalRecordMedicalCondition.path
    }
    ...
    const medicalRecordConditionService = {
        name: config.services.medicalRecordMedicalCondition.name,
        path: config.services.medicalRecordMedicalCondition.path
    }
